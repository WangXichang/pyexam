...
"""
    ...
    stmold module description stm模块说明：
    ...
    [functions] 模块中的函数
       run(name, df, col, ratio_list, grade_max, grade_diff, raw_score_max, raw_score_min,
          ...
          ---
          usage:调用方式
          [1] import pyex_stm as stmold
          [2] m = stmold.run(name='shandong', df=data, col=['ls'])
          [3] m.report()
          [4] m.output.head()
...
class PltScore(ScoreTransformModel):
    ...
    def run(self):
        ...
        print('='*100)
        print('stmold-run end, elapsed-time:', time.time() - stime)
    ...
    def __plot_norm_test(self):
        ...
        for col in self.cols:
            ...
            # fig.suptitle('norm test for stmold models')
